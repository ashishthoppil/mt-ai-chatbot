...
export async function POST(request) {
  ...
  const instructions = [{
    ...
    content: `
      ...
      <br/>
      <a className='flex justify-end gap-1 text-black' target='_blank' href='URL'><span>Read more</span> <img width="15" height="15" src="https://img.icons8.com/flat-round/50/link--v1.png" alt="link--v1"/>></a>
