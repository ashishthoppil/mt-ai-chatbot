...
export default function Login() {
    ...
    return (
        <div className='flex items-center bg-purple-800 w-full rounded-[30px] py-[5rem]'>
            <div className='flex flex-col gap-10 items-center w-[50%] border-r-[1px] border-slate-500 py-10'>
